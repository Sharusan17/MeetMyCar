...
const ToolBar = () => {
  ...
  useEffect(() => {
    async function fetchUserData(){
        // fetches current user data, and stores the data (id, username and profile Picture) into useState, to be used throughout the page.
        try{
    ...
    <>
      <body>
        <nav className='toolbar'>
          {/* Lists of different pages as toolbar with img and text */}
            <ul className='toolbar-ul'>
              ...
              {/* Navigate to Own Profile */}
              <li className='toolbar-item'>
                <Link to={`/profile/${userId}`} className='item-link'>
              ...
              <li className='toolbar-item'>
                <Link to="/setting" className='item-link'>
